		...
		<div class="col-md-12">
			<div class="box box-danger collapsed-box">
				...
				<div class="box-body" style="<?php if($search_filters != 0) { echo "display: block;"; } ?>">
					<form id="search-form" method="get" action="<?php echo Yii::app()->createUrl('loan/index'); ?>">
						<div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-3">
								<?php echo CHtml::link('<span class="fa fa-refresh"></span> Reset', array('loan/index'), array('class'=>'btn btn-danger btn-flat', 'title'=>'Reset Filters')); ?>
