      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <?php
              // echo $form->dropDownList($message, 'to_account_id',
              //   CHtml::listData($approved_accounts, 
              //   'id', 'username'), array('empty' => 'Select Account', 'class'=>'form-control select2'));
            ?>
            <select name="Message[to_account_id]" class="form-control" required>
              <option value="" disabled selected>Select Account</option>
              <?php foreach ($approved_accounts as $value): ?>
        ...
        <div class="box-footer">
          <div class="pull-right">
            <a id="btn-drafts" href="javascript:void(0);" data-target="<?php echo Yii::app()->createUrl('admin/message/compose', array('drafts'=>'true')) ?>" class="btn btn-warning btn-flat"><i class="fa fa-pencil"></i> Drafts</a>
