<section class="content-header">
	...
	<ol class="breadcrumb">
		<li>
			<?php echo CHtml::link("Content Management", array('content/add')); ?>
		</li>
...
<section class="content">
	<div class="box">
		...
		<div class="box-footer">
			<?php echo CHtml::link("Back", array('content/index'), array('title'=>'Back', 'class'=>'btn btn-danger btn-flat', 'confirm'=>'Are you sure you want to Discard your Changes?')) ?>
			<div class="pull-right">
				<?php echo CHtml::submitButton($content->isNewRecord ? 'Create' : 'Save', array('class'=>'btn btn-primary btn-flat pull-right', 'id'=>'btn-submit', 'tabindex'=>4)); ?>
			</div>
		</div>
		<?php $this->endWidget(); ?>
	</div>
